...
/**
 * Transaction — enfant d'Account (**cascade**) et liée à une récurrence source
 * (**nullify** : supprimer une récurrence conserve l'historique généré en mettant
 * `sourceRecurringId` à null).
 */
@Entity(
    ...
    indices = [Index("accountId"), Index("sourceRecurringId")],
)

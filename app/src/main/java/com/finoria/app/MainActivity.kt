...
class MainActivity : ComponentActivity() {
    ...
    // Android 13+ : les notifications (rappel hebdomadaire WorkManager) nécessitent
    // une permission runtime. Refuser est sans conséquence : le worker ignore
    // silencieusement l'envoi (SecurityException attrapée).
